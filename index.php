...
$botToken = "7391664631:AAF-vOiBCvuNT5RxfszLEjyY4i-pWPEtu94";
...
$emojid = '❌';
$emojil = '✅';
$owner = '<code>@XFearless7 , @omt152</code>';
$botu = "𝘽𝙊𝙏 𝙐𝙋𝘿𝘼𝙏𝙀𝙎 ↯ @omt152 , @XFearless7";
$bota = "<b>|×| 𝘿𝙀𝙑 ↯ @omt152 , @XFearless7</b>";$eror = "<b>Error ❌</b>";
...
$owner = '<code>@omt152 , @XFearless7</code>';
...
⚠️ 𝘛𝘏𝘐𝘚 𝘛𝘖𝘗-𝘜𝘗s 𝘈𝘙𝘌 𝘕𝘖𝘕 𝘙𝘌𝘍𝘜𝘕𝘋𝘈𝘉𝘓𝘌 ⚠️";
                                 ...
                                 $gatesKeyboard = json_encode([
                                 'inline_keyboard' => [
                                     [                     ['text' => '• 𝙑𝙀𝙍𝙄𝙁𝙔 𝙋𝘼𝙔𝙈𝙀𝙉𝙏 •', 'url' => 'https://t.me/XFearless7'],   ], 
                                                               [                     ['text' => '• 𝙑𝙀𝙍𝙄𝙁𝙔 𝙋𝘼𝙔𝙈𝙀𝙉𝙏 •', 'url' => 'https://t.me/omt152 , '],   ], ]
  ]);
...
$keyboard = json_encode([
    'inline_keyboard' => [
        [
            ['text' => "↯ 𝘽𝙐𝙔 𝘼𝘾𝘾𝙀𝙎𝙎", 'url' => "https://t.me/XFearless7"],
        ],
    ]
]);
...
$channel = json_encode([
    'inline_keyboard' => [
        [['text' => "𝙊𝙒𝙉𝙀𝙍", 'url' => "t.me/XFearless7"], ['text' => "𝘾𝙃𝘼𝙉𝙉𝙀𝙇", 'url' => "https://t.me/XFearless7"]],
        [['text' => "𝙂𝙊 𝘽𝘼𝘾𝙆 ", 'callback_data' => 'back2']]
    ]
]);
