...
$owners = ["6291204661", "6716561862", "6606993263", "1756796106"];  // Add owner ids here
...
if (isset($update['message']['text'])) {
    ...
    if ($message === '/users') {
        if (in_array($chat_id, $owners)) {
            ...
            $response = "<b>[×] Total users: {$freeUserCount}%0A[×] Paid users: {$paidUserCount}%0A[×] Banned users: {$banUserCount}%0A%0A[×] Bot by: @XFearless7 , @omt152 </b>";
        } else {
